...
private:
    ...
    static void split(const string &str,production *t,map<string, production *> &nonterminals,map<string, production *> &terminals);
    static vector<string> splitSpace(const string &str);
