...
LexRules *LexRules::instance = nullptr;
...
vector<LexicalRule *> LexRules::read_from_file(const string &input_file, map<string, int> *priorities) {
...
string LexRules::removeSpaces(string str) {
    str.erase(remove(str.begin(), str.end(), ' '), str.end());
    return str;
}

vector<string> LexRules::split_each_char(const string &str) {
...
vector<string> LexRules::split_by_spaces(string to_be_splitted) {
...
vector<string> LexRules::split_for_regular_definition(const string &str) {
    vector<string> after_split;
    string ans;
    for (auto i : str) {
...
vector<string> LexRules::split_for_regular_expression(const string &str) {
    vector<string> after_split;
    string ans;
    for (auto i : str) {
        if (ans == "\\") {
...
LexRules *LexRules::getInstance() {
    if (instance == nullptr) {
        instance = new LexRules;
    }
    return instance;
}

void LexRules::printTable(const string &fileName, const map<Node *, map<char, Node *>> &table,
